...
const OrdersTable = () => {
  ...
  const handleChange = (event) => {
    ...
    if (name === "sort") {
      ...
      let sortedOrders = [...adminsOrder.orders];
      sortedOrders.sort((a, b) => {
        // Define the order of status according to your requirement
        const statusOrder = ["PLACED", "CONFIRMED", "DELIVERED", "CANCELED"];
        return statusOrder.indexOf(a.orderStatus) - statusOrder.indexOf(b.orderStatus);
      });
      if (value === "Oldest") {
        // If sorting by oldest, reverse the order
        sortedOrders.reverse();
      }
      // Update state with sorted orders
      dispatch({ type: "SET_SORTED_ORDERS", payload: sortedOrders });
    }
  };
