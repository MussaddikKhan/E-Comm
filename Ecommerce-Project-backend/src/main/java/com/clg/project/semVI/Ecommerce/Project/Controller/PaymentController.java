...
import com.clg.project.semVI.Ecommerce.Project.Repository.OrderRepository;
import com.clg.project.semVI.Ecommerce.Project.Response.ApiResponse;
import com.clg.project.semVI.Ecommerce.Project.Response.PaymentLinkResponse;
...
import com.clg.project.semVI.Ecommerce.Project.user.domain.OrderStatus;
import com.clg.project.semVI.Ecommerce.Project.user.domain.PaymentStatus;
    ...
    public ResponseEntity<ApiResponse> redirect(@RequestParam(name="payment_id") String paymentId, @RequestParam("order_id")Long orderId) throws RazorpayException, OrderException {
        ...
        try {
            ...
            if(payment.get("status").equals("captured")) {
                ...
                LocalDateTime now = order.getCreatedAt(); 
